      ...
      <form className='flex flex-col sm:flex-row gap-7'>
        <div className='flex flex-col gap-4 flex-1'>
          ...
          <div className='flex flex-wrap gap-6 my-1'>
            ...
            <div className='flex items-center gap-2'>
              <input type="number" id='regularPrice' min='1' max='30' required className='p-3 border border-gray-300 rounded-lg w-40'/>
            ...
            <div className='flex items-center gap-2'>
              <input type="number" id='discountPrice' min='1' max='30' required className='p-3 border border-gray-300 rounded-lg w-40'/>
              <div className='flex flex-col items-center'>
